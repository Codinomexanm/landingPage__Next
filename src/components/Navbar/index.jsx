  ...
  return (
    <>
      <nav className="navbar">
        ...
        <div className='links'>
          <ul id="navbars" className={clicked ? 'navbars active' : 'navbars'} onClick={() => setClicked(false)}>
            <li><Link href="/" className={activeLink === 'home' ? 'active' : ''} onClick={() => handleClick('home')}>Home</Link></li>
            <li><Link href="/about" className={activeLink === 'about' ? 'active' : ''} onClick={() => handleClick('about')}>Sobre</Link></li>
            <li><Link href="/contact" className={activeLink === 'contact' ? 'active' : ''} onClick={() => handleClick('contact')}>contato</Link></li>
          </ul>
        </div>
        <div id="mobile">
          <i id='bar' className={clicked ? 'active' : ''} onClick={toggleNavbar}>
            {clicked ? <FiCrosshair size={28} color='#ea3140' /> : <FiMenu size={28} color='#ea3140' />}
          </i>
        </div>
      </nav>
    </>
