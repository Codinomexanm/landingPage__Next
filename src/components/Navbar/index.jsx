  ...
  return (
    <>
      <nav className="navbar">
        ...
        <div className='links'>
          <ul id="navbars" >
            <li><ActiveLink href="/" activeClassName={styles.active}><p>Inicio</p></ActiveLink></li>
            <li><ActiveLink href="/about" activeClassName={styles.active}><p>Sobre</p></ActiveLink></li>
            <li><ActiveLink href="/contact" activeClassName={styles.active}><p>contato</p></ActiveLink></li>
          </ul>
        </div>
        <div id="mobile">
